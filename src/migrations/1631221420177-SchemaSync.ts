...
export class SchemaSync1631221420177 implements MigrationInterface {
  name = 'SchemaSync1631221420177';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "public"."coffee" ADD "recommendations" integer NOT NULL DEFAULT '0'`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "public"."coffee" DROP COLUMN "recommendations"`,
    );
    await queryRunner.query(
